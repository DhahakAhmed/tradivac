...
public class AJouterReclamationFXMLController implements Initializable {
    ...
    private String generateTicket(String object, String contenu) {
        ...
        try {
            ...
            String[] contentInfo = {
                "Object: "  + contenu,
                "Contenu: " + object,
                "Numero Reclamation: #" + randomNumber};
    ...
    public void setData(ObservableList<Reclamation> reclamationInstance) {
...
//****************************************************************
    ...
    @FXML
    private void addReclamation(ActionEvent event) throws MessagingException {
